...
(function() {
  var crypto, init_SocketClient, init_SocketServ, moment, net, objCon, objData, zlib, __$day, __$hr, __$min, __$second, __Hash, __debug, __logit, __onData, __tStamp, __ttl_time;
  ...
  __onData = function(objCon, data) {
    var tBuff, tData, tLen;
    if (data != null) {
      objCon.__bffr = Buffer.concat([objCon.__bffr, data]);
    }
  ...
  init_SocketClient = function(aHost, aPort, aAPI, callback) {
    var c, cli_bffr, tCallback, tConn;
    tConn = null;
